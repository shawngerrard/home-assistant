...
This guide will outline how to deploy the integrations to ~home-assistant~ from ~gcp~.

*** Pre-requisites

This guide assumes the following:

1. You have an account up to use the [[https://console.cloud.google.com/][Google Cloud Platform]].
2. You have a project created in ~gcp~ for Pulumi to interact with.
