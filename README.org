...
Next, access the [[https://console.nest.google.com/device-access/][device access console]] and follow through the payment flow - this will cost a one-off $5 developer registration fee.
